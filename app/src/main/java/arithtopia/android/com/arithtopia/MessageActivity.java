...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(arithtopia.android.com.arithtopia.R.layout.activity_massage);
        ...
        tvToolbarTitle.setText(arithtopia.android.com.arithtopia.R.string.get_answer);
        //------------------------------------------------------
