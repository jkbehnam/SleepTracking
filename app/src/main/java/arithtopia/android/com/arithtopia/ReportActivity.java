...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(arithtopia.android.com.arithtopia.R.layout.activity_report);
        ...
        tvToolbarTitle.setText(arithtopia.android.com.arithtopia.R.string.selling_question);
        //------------------------------------------------------
