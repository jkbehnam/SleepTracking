...
public class QuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(arithtopia.android.com.arithtopia.R.layout.activity_question);
        ...
        tvToolbarTitle.setText(arithtopia.android.com.arithtopia.R.string.add_gamer);
        //------------------------------------------------------
